...
const PAGE_DEFS = [
  { key: 'startseite', label: '🏠 Startseite (index.html)', sections: [
    ...
    { key: 'contact_venue',    label: 'Spiel- & Trainingsort',    hint: 'Halle, in der gespielt und trainiert wird' },
    { key: 'contact_address',  label: 'Vereinssitz',              hint: 'Adresse laut Vereinsregister (Impressum)' },
...
const COLLECTION_DEFS = {
  teams: {
    ...
    fields: [
      ...
      { key: 'season',      label: 'Saison',                   type: 'text',  hint: 'z. B. Saison 2026/27' },
